...
public class Vote {
	...
	/**
	 * @param chosen_option
	 *            the chosen_option to set
	 */
	public void setChosen_option(int chosen_option) {
		this.chosen_option = chosen_option;
	}

	public void checkVoteInput() throws NullPointerException {
		if (this.pollId == 0) {
		...
		if (this.chosen_option == 0) {
			throw new NullPointerException("No chosen_option provided");
		}
